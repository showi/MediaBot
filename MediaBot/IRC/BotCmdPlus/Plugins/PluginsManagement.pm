package MediaBot::IRC::BotCmdPlus::Plugins::PluginsManagement;
...
use MediaBot::Log;
use MediaBot::String;
use MediaBot::IRC::BotCmdPlus::Helper qw(get_cmd);
...
use MediaBot::IRC::BotCmdPlus::Plugins::Mode;
...
sub _load_plugin {
    ...
    for ( @{$s->plugins} ) {
        ...
        my $plugin = "MediaBot::IRC::BotCmdPlus::Plugins::$name";
